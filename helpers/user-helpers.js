...
var instance = new Razorpay({
  key_id:'rzp_test_VbJCeTQ37DpGUl',
  key_secret: 'uzG4ZGHCZEukButdu5lMVb2j',
});
module.exports = {
  doSignUp: (userData) => {
...
//console.log(today);
    return new Promise((resolve,reject)=>{
      let todate= new Date()
      console.log("vnjfvnhjbfv0"+todate)
      ...
      let usr={
       ...
       db.get()
       .collection(collection.TABLE_RESERVATION)
       .insertOne(usr)
       .then((data)=>{
         resolve(data.ops[0])
       })
  ...
  placeOrder: (order, products, total) => {
    return new Promise((resolve, reject) => {
      ...
      //console.log("dvdfvfzdrg"+orderdate)
